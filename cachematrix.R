...
# and assigns it into another environmet for storage then,
# Sets an inverse of a matrix m
# Gets the inverse of that matrix
# Creates a list all the above variables(get, set, getinverse, setinverse) to be used by the next function
